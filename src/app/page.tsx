            ...
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Unleash Your Creative Potential</h2>
                  <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Visuals AI empowers you to create stunning marketing assets with ease. Upload your photos and let our
                  ...
                  <ul className="grid gap-6">
                    <li>
                      <div className="grid gap-1">
                        ...
                        <p className="text-muted-foreground">
                          Easily upload your photos to the platform and let Visuals AI work its magic.
                        </p>
                      </div>
                    </li>
                    <li>
                      <div className="grid gap-1">
                        <h3 className="text-xl font-bold">Asset Generation</h3>
                        <p className="text-muted-foreground">
                          Visuals AI will automatically generate a variety of marketing assets based on your uploaded
                          photos.
                        </p>
                      </div>
                    </li>
                    <li>
                      <div className="grid gap-1">
                        ...
                        <p className="text-muted-foreground">
                          Tailor the generated assets to your brand by adjusting colors, layouts, and more.
                        </p>
                      </div>
                    </li>
                  </ul>
